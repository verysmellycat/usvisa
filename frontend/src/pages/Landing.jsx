  ...
  return (
    ...
    >
      <div className="container mx-auto flex min-h-screen flex-col gap-y-6 pb-12">
        <div className="flex flex-col gap-y-6 py-6 md:h-screen lg:gap-y-3">
          <div className="flex grow flex-col justify-center gap-y-6">
            ...
            <p className="text-center text-lg text-foreground-500">
              Blazing fast, optimized system with multi-country support,
              featuring automatic slot monitoring, rescheduling and real-time
              notification. It does it all for you.
            </p>
            <Button
          ...
          <div className="flex flex-col gap-y-6">
              ...
              <div className="space-y-3 border border-foreground px-3 py-3 md:col-span-4 md:py-6">
                <div className="space-y-1.5">
                  ...
                  <p className="text-center text-base text-foreground-500 lg:text-lg">
                    Our standard mode. Best for average use cases and suitable
                    for most users.
                  </p>
                </div>
            ...
            <div className="space-y-2 text-sm text-foreground-500 lg:text-base">
              <div className="space-y-1.5 text-foreground">
                ...
                <p>
                  2. Collect at least price/2 likes and bookmarks (that's 10
                  each if you paid $20).
                </p>
              </div>
              <p>
                Pricing is determined by the operational costs, which varies
                across countries based on the average server running time to
                grab a slot.
              </p>
              <p>
