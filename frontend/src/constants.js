export const aisFaq = [
  ...
  {
    question:
      "我需要取消已有的预约才能用这个程序吗？我已有的预约会被程序取消吗？",
    answer:
...
export const cgiFaq = [
  {
    question: "我需要有预约才能用这个程序吗？",
    answer: "是的，程序只支持改约时间，如果没有预约可以随便预约一个。",
  },
  {
    question: "我已有的预约会被程序取消吗？",
    answer:
      "不会。程序只会重新预约你期望日期范围内的面试时间，请确保你的密码安全。",
  },
  {
    question: "信息填错了或者想更改日期范围怎么办？",
    answer:
      "提交新的刷签请求，新的请求会覆盖旧的，在插件中输入自动回邮里新的token即可。",
  },
];
